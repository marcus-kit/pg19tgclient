...
<template>
  <nav class="fixed bottom-0 left-0 right-0 z-50 bg-gray-900/95 backdrop-blur-lg border-t border-white/10">
    <div class="flex items-center justify-around h-16 px-2">
      ...
      <button
        @click="handleLogout"
        class="flex flex-col items-center gap-1 py-2 px-3 rounded-lg text-gray-400 hover:text-white transition-colors"
      >
