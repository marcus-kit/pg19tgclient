  ...
  <UCard class="lg:col-span-2">
    ...
    <div class="grid lg:grid-cols-2 gap-6">
        ...
        <div class="grid grid-cols-2 gap-3 mb-4">
          ...
          >
            <p class="text-2xl font-bold text-[var(--text-primary)]">
              {{ authStore.referralProgram?.totalInvited }}
            </p>
          ...
          >
            <p class="text-2xl font-bold text-accent">
              {{ authStore.referralProgram?.totalBonus }} ₽
            </p>
            <p class="text-sm text-[var(--text-muted)]">
              Заработано
            </p>
        ...
        <div>
          ...
          <div class="flex gap-2">
            ...
            >
              <Icon
                name="heroicons:link"
                class="w-5 h-5 text-[var(--text-primary)] mx-auto"
              />
            </button>
          </div>
        </div>
      ...
      <div>
        ...
        <div
          v-if="authStore.referralProgram?.referrals?.length"
          class="space-y-2"
        >
          <div
        ...
        >
          ...
          <p class="text-sm text-[var(--text-muted)] mt-1">
            Поделитесь промокодом и получите 300 ₽
          </p>
        </div>
