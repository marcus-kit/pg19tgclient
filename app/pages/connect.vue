          ...
          <form v-else @submit.prevent="submitForm" class="space-y-6">
            ...
            <div class="opacity-0 animate-fade-in-up">
              ...
              <input
                ...
                class="w-full px-4 py-4 rounded-xl bg-white/5 border border-white/10 text-[var(--text-primary)] placeholder-gray-500 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-colors"
              />
            </div>

            <!-- Phone -->
            <div class="opacity-0 animate-fade-in-up stagger-1">
              <label for="phone" class="block text-sm font-medium text-[var(--text-secondary)] mb-2">
            ...
            <div class="opacity-0 animate-fade-in-up stagger-2">
              <label for="address" class="block text-sm font-medium text-[var(--text-secondary)] mb-2">
                Адрес подключения
              </label>
              <input
                id="address"
            ...
            <div class="opacity-0 animate-fade-in-up stagger-4">
              <label for="comment" class="block text-sm font-medium text-[var(--text-secondary)] mb-2">
                Комментарий
              </label>
              <textarea
                id="comment"
                ...
                class="w-full px-4 py-4 rounded-xl bg-white/5 border border-white/10 text-[var(--text-primary)] placeholder-gray-500 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-colors resize-none"
              ></textarea>
            </div>
            ...
            <!-- Legal -->
            <p class="text-xs text-[var(--text-muted)] text-center opacity-0 animate-fade-in-up stagger-6">
        ...
        <div class="max-w-3xl mx-auto">
          ...
          <div class="grid md:grid-cols-3 gap-8">
            <div class="text-center">
              ...
              <p class="text-[var(--text-muted)] text-sm">Оставьте заявку на сайте или позвоните нам</p>
            </div>
            <div class="text-center">
              <div class="w-16 h-16 glass-card rounded-2xl flex items-center justify-center mx-auto mb-6">
                <span class="text-2xl font-bold text-secondary">2</span>
              </div>
              <h3 class="font-semibold text-[var(--text-primary)] mb-2">Консультация</h3>
              <p class="text-[var(--text-muted)] text-sm">Мы проверим возможность подключения и расскажем об условиях</p>
            </div>
            <div class="text-center">
              <div class="w-16 h-16 glass-card rounded-2xl flex items-center justify-center mx-auto mb-6">
