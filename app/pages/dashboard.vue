...
<template>
  <div class="space-y-6">
    ...
    <section>
      ...
      <div
        v-else-if="error"
        class="p-6 bg-red-500/10 border border-red-500/20 rounded-lg"
      >
      ...
      <div
        ...
        class="p-8 text-center bg-white/5 rounded-lg"
      >
        <Icon
      ...
      >
        ...
        >
          <div class="flex items-center gap-2 mb-2">
            ...
            <UBadge
              :variant="categoryVariants[item.category]"
              size="sm"
            >
            ...
            <Icon
              ...
              class="w-3 h-3 text-primary ml-auto"
            />
          </div>
